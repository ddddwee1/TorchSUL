...
class ResNet(M.Model):
	def initialize(self, channel_list, blocknum_list, embedding_size):
...
def Res34(dim=512):
	return ResNet([64,64,128,256,512],[3,4,6,3],dim)

def Res50(dim=512):
	return ResNet([64,64,128,256,512],[3,4,14,3],dim)
	
def Res100(dim=512):
	return ResNet([64,64,128,256,512],[3,13,30,3],dim)
