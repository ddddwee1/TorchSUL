...
if __name__=='__main__':
	...
	BackboneRes100 = DeepViT(image_size=112, patch_size=16, dim=512, depth=16, heads=16, mlp_dim=2048, dropout=0.1, emb_dropout=0.1)
	...
	for ep in range(MAXEPOCH):
		...
		for it in bar:
			...
			if it%8000==0 and it>0:
				saver.save('./model/dvit_%d_%d.pth'%(ep, it))
